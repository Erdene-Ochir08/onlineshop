                            ...
                            @if ($cartItem->product)
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 my-auto">
                                            <label class="price">{{ $cartItem->product->sale_percent }} % </label>
                                        </div>

                                        <div class="col-md-1 my-auto">
                                            <label class="price">
                                                {{($cartItem->product->price * $cartItem->quantity) - ($cartItem->product->price * $cartItem->quantity *($cartItem->product->sale_percent/100))}} ₮
                                            </label>
                                            @php $totalPrice += ($cartItem->product->price * $cartItem->quantity) - ($cartItem->product->price * $cartItem->quantity *($cartItem->product->sale_percent/100)) @endphp
                                        </div>
